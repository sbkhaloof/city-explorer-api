...
const getWeatherInfoHandler=require('./modules/weather.js')
const getMoviesHandler=require('./modules/movie.js')
...
//-------------------------------constrctour for weather lab8
// class Forecast{
//     constructor(date,description){
//     this.date=date;
//     this.description=description
// }}
//--------------------------------------constrcture for movie lab8
// class Movie{
